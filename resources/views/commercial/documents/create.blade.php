                    ...
                    <form action="{{ route('commercial.documents.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="category" class="form-control @error('category') is-invalid @enderror" required>
                                ...
                                <option value="Formulários" {{ old('category') == 'Formulários' ? 'selected' : '' }}>Formulários</option>
                                <option value="Manuais" {{ old('category') == 'Manuais' ? 'selected' : '' }}>Manuais</option>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input type="radio" name="type" value="link" id="typeLink" class="form-check-input" 
                                       {{ old('type', 'link') == 'link' ? 'checked' : '' }}>
                                <label for="typeLink" class="form-check-label">
                                    <i class="bi bi-link-45deg"></i> Link (URL)
                                </label>
                            </div>
                            <div class="form-check">
                                <input type="radio" name="type" value="file" id="typeFile" class="form-check-input" 
