<div class="row">
    <div class="col-md-5 mb-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-header bg-white border-0 pt-4">
                <h4 class="mb-0">
                    <i class="bi bi-people-fill text-primary me-2"></i>Consultores por Região
                </h4>
            </div>
            <div class="card-body">
                            ...
                            <h2 class="accordion-header">
                                <button class="accordion-button {{ $index != 0 ? 'collapsed' : '' }} bg-light rounded"
                                    ...
                                    <div class="d-flex justify-content-between w-100 me-3">
                                        <strong class="text-primary">{{ $area->region }}</strong>
    ...
    <div class="col-md-7 mb-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-header bg-white border-0 pt-4">
                <h4 class="mb-0">
                    <i class="bi bi-map-fill text-primary me-2"></i>Mapa de Atendimento
                </h4>
            </div>
            <div class="card-body">
        ...
        areas.forEach(function (area) {
            ...
            var popupContent = `
                <div class="text-center">
                    <strong class="text-primary">${area.region}</strong><br>
