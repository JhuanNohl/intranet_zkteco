                        ...
                        <form action="{{ route('comunicados.update', $comunicado) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="conteudo" id="conteudo" class="form-control @error('conteudo') is-invalid @enderror"
                                    rows="6" required>{{ old('conteudo', $comunicado->conteudo) }}</textarea>
                                @error('conteudo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="autor" id="autor" class="form-control @error('autor') is-invalid @enderror"
                                    value="{{ old('autor', $comunicado->autor) }}" placeholder="Deixe em branco para usar seu nome">
                                @error('autor')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" name="data_validade" id="data_validade" class="form-control @error('data_validade') is-invalid @enderror"
                                        value="{{ old('data_validade', $comunicado->data_validade) }}">
                                    @error('data_validade')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="ordem" id="ordem" class="form-control @error('ordem') is-invalid @enderror"
                                        value="{{ old('ordem', $comunicado->ordem) }}" placeholder="1, 2, 3...">
                                    @error('ordem')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3 form-check">
                                <input type="checkbox" name="ativo" id="ativo" class="form-check-input checkbox-success" value="1" {{ old('ativo', $comunicado->ativo) ? 'checked' : '' }}>
                            ...
                            <div class="d-flex gap-2 justify-content-end">
                                ...
                                <button type="submit" class="btn btn-success">
                                    <i class="bi bi-check-circle me-1"></i>Atualizar Comunicado
                                </button>
                            </div>
                        </form>
                    </div>
